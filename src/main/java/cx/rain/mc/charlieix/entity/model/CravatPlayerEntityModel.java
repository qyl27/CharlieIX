...
public class CravatPlayerEntityModel extends EntityModel<PlayerEntity> {
	...
	public CravatPlayerEntityModel() {
		textureWidth = 32;
		textureHeight = 32;
		...
		group2.setTextureOffset(0, 23).addBox(-0.3879F, -0.4228F, -0.5F, 4.0F, 2.0F, 1.0F, 0.0F, false);
		group2.setTextureOffset(0, 16).addBox(-0.9379F, -0.8978F, -0.502F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		...
		cube_r1.setTextureOffset(0, 27).addBox(-2.5044F, -1.5208F, -0.5091F, 2.0F, 3.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(0, 21).addBox(1.1911F, 0.0099F, -0.5091F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		...
		group.setTextureOffset(0, 16).addBox(-8.3879F, -0.4228F, -0.5F, 4.0F, 2.0F, 1.0F, 0.0F, false);
		group.setTextureOffset(0, 16).addBox(-8.7129F, -0.8978F, -0.502F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		...
		cube_r3.setTextureOffset(0, 16).addBox(0.5044F, -1.5208F, -0.5091F, 2.0F, 3.0F, 1.0F, 0.0F, false);
		cube_r3.setTextureOffset(0, 16).addBox(-2.4411F, 0.0099F, -0.5091F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		...
		cube_r5.setTextureOffset(0, 13).addBox(-1.5F, -1.5F, -1.5F, 1.0F, 3.0F, 3.0F, 0.0F, false);
		cube_r5.setTextureOffset(0, 13).addBox(0.5F, -1.5F, -1.5F, 1.0F, 3.0F, 3.0F, 0.0F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-8.0F, -0.5F, 8.0F);
		bone.addChild(cube_r6);
		setRotationAngle(cube_r6, -0.3927F, 0.0F, 0.0F);
		cube_r6.setTextureOffset(0, 14).addBox(-0.5F, -1.25F, -1.25F, 1.0F, 2.0F, 2.0F, 0.0F, false);
	}
